...
1. Observe how Copilot references the general project instructions and the assignment specific instruction files.
   ...
   <img width="600" alt="screenshot of Copilot chat showing attached references" src="https://github.com/hemabalangit/2skills-customize-your-github-copilot-experience2/blob/main/.github/images/copilot-chat-reviews-instructions.png?raw=true" />
